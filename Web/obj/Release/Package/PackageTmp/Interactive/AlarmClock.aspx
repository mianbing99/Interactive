<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlarmClock.aspx.cs" Inherits="Web.Interactive.AlarmClock" %>
        ...
        $(document).ready(function () {
            ...
            $(".idclass_k").click(function () {
                ...
                $.ajax({
                    url: 'AlarmClock.aspx',
                    type: 'post',
                    data: { "type":"updateState","state":"开启","id": id },
            ...
            $(".idclass_g").click(function () {
                ...
                $.ajax({
                    url: 'AlarmClock.aspx',
                    type: 'post',
                    data: { type:"updateState",state:"关闭",id: id },
                    success: function (data) {
                    }
                });
                $(this).css('display', 'none');
